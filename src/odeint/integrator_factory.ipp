...
IntegratorFactory<EquationType>::build(const tbox::PropertyTree& ptree, const StepBasePtr& stp, const ObsBasePtr& obs){
	...
	IntegratorPtr integrator_ptr(new Integrator<Equation>(stp,obs,traits));
